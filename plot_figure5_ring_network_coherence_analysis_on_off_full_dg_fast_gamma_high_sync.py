...
data_dir = os.path.join(dirname, 'output', 'figure_5_fast_gamma_input_high_sync')
...
for cell in neuron_types.keys():
    ...
    for curr_file in all_files:
        ...
        temporal_patterns = np.array([inhomogeneous_poisson_process(0.0, duration, dt/1000, 80, peak_freq, refractory_period=0.001) for x in range(n_inputs)], dtype=object) * 1000
