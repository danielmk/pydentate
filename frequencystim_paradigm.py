...
stim_dur = 6
stim_delay = 100
stim freq = 50 # Stimulation frequency in Hz
...
for rep in range(reps):
    ...
    target_idc = np.random.choice(ctrl_nw.populations[0].get_cell_number(), n_cells, replace = False)
    clamp_idx = np.random.choice()
