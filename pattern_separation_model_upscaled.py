...
if __name__ == '__main__':
    ...
    innervation_pattern_gc = np.array([np.random.choice(100,20, replace = False) for x in range(2000)])
    ...
    innervation_pattern_bc = np.array([np.random.choice(100,20, replace = False) for x in range(24)])
