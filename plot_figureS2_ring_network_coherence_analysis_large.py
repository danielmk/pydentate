...
data_dir = os.path.join(dirname, 'output', 'figure_S2_large')
...
off_off_cells = (df.loc[off_off_example]['file'].root.units[df.loc[off_off_example]['file'].root.times.read() < 200] % 40 == 0)
on_off_cells = (df.loc[on_off_example]['file'].root.units[df.loc[on_off_example]['file'].root.times.read() < 200] % 40 == 0)
off_on_cells = (df.loc[off_on_example]['file'].root.units[df.loc[off_on_example]['file'].root.times.read() < 200] % 40 == 0)
on_on_cells = (df.loc[on_on_example]['file'].root.units[df.loc[on_on_example]['file'].root.times.read() < 200] % 40 == 0)


fig, ax = plt.subplots(3, 4)
ax[0, 0].scatter(df.loc[off_off_example]['file'].root.times[df.loc[off_off_example]['file'].root.times.read() < 200][off_off_cells], df.loc[off_off_example]['file'].root.units[df.loc[off_off_example]['file'].root.times.read() < 200][off_off_cells], marker='|', color=colors[0])
ax[0, 1].scatter(df.loc[on_off_example]['file'].root.times[df.loc[on_off_example]['file'].root.times.read() < 200][on_off_cells], df.loc[on_off_example]['file'].root.units[df.loc[on_off_example]['file'].root.times.read() < 200][on_off_cells], marker='|', color=colors[1])
ax[0, 2].scatter(df.loc[off_on_example]['file'].root.times[df.loc[off_on_example]['file'].root.times.read() < 200][off_on_cells], df.loc[off_on_example]['file'].root.units[df.loc[off_on_example]['file'].root.times.read() < 200][off_on_cells], marker='|', color=colors[2])
ax[0, 3].scatter(df.loc[on_on_example]['file'].root.times[df.loc[on_on_example]['file'].root.times.read() < 200][on_on_cells], df.loc[on_on_example]['file'].root.units[df.loc[on_on_example]['file'].root.times.read() < 200][on_on_cells], marker='|', color=colors[3])
