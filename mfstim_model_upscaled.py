...
class MFStimNetwork(ouropy.gennetwork.GenNetwork):
    ...
    def __init__(self, seed = None, n_cells = 200, stim_int = 20):
        ...
        # GC -> MC
        self.mk_Exp2SynConnection(self.populations[0], self.populations[1], 12,
                                   'proxd', 1, 0.5,6.2, 0, 10, 1.5, 0.2*10**(-3))
        
        # GC -> BC
        self.mk_Exp2SynConnection(self.populations[0], self.populations[2], 12,
                                   'proxd', 1, 0.3, 0.6, 0, 10, 0.8, 4.7*10**(-3))
        
        # GC -> HC
        self.mk_Exp2SynConnection(self.populations[0], self.populations[3], 20,
        ...
        # MC -> MC
        self.mk_Exp2SynConnection(self.populations[1], self.populations[1], 24,
                                   'proxd', 1, 0.45, 2.2, 0, 10, 2, 0.5*10**(-3))
        
        # MC -> BC
        self.mk_Exp2SynConnection(self.populations[1], self.populations[2], 12,
                                   'proxd', 1, 0.1, 0.1, 1, 10, 3, 0.3*10**(-3))
        
        # MC -> HC
        self.mk_Exp2SynConnection(self.populations[1], self.populations[3], 20,
        ...
        self.mk_Exp2SynConnection(self.populations[2], self.populations[0], 560,
                                   'soma', 100, 1, 18, -70, -10, 0.85, 1.6*10**(-3))

        # BC -> MC
        self.mk_Exp2SynConnection(self.populations[2], self.populations[1], 28,
                                   'proxd', 3, 0.3, 3.3, -70, -10, 1.5, 1.5*10**(-3))
        
        # BC -> BC
        self.mk_Exp2SynConnection(self.populations[2], self.populations[2], 1040,
        ...
        self.mk_Exp2SynConnection(self.populations[3], self.populations[0], 1040,
                                   'dd', 160, 1, 18, -70, 10, 1.6, 0.5*10**(-3))
        
        # HC -> MC
        self.mk_Exp2SynConnection(self.populations[3], self.populations[1], 20,
                                   ['mid1d', 'mid2d'], 4, 0.5, 6, -70, 10, 1, 1.5*10**(-3))
        
        # HC -> BC
        self.mk_Exp2SynConnection(self.populations[3], self.populations[2], 20,
