...
data_path = "C:\\Users\\Daniel\\pyDentateData\\pattern_separation_data_local_input_revised\\seed10003\\scale1000\\net_globalrev\\"
save_path = data_path
...
for x in data_files:
    ...
    curr_spike_data = analysis_main.time_stamps_to_signal(data['net_globalrev.TunedNetwork']['populations'][0]['ap_time_stamps'], dt_signal=0.1, t_start=0, t_stop=600)
